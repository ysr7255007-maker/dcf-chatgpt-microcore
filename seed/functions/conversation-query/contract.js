...
/**
 * seed/functions/conversation-query/contract.js — Runtime Zod Schema Mirror
 */

const { z } = require('zod');

exports.ConversationQueryIntentSchema = z.object({
...
exports.ConversationResultSchema = z.array(z.object({
    id: z.string(),
    version: z.number(),
    title: z.string(),
