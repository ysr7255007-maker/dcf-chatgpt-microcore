...
/**
 * seed/functions/task-generation/contract.js — Runtime Zod Schema Mirror
 */

const { z } = require('zod');

exports.GenerationIntentSchema = z.object({
...
exports.GenerationProductSchema = z.object({
    type: z.string(),
    title: z.string(),
...
exports.GenerationRequestResultSchema = z.object({
    ok: z.boolean(),
    data: z.object({
        task_id: z.string(),
        mode: z.string(),
...
exports.GenerationResponseSchema = z.object({
    task_id: z.string(),
