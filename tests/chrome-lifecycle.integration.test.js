...
(async () => {
  ...
  assert.strictEqual(registrations.length, 9);
  assert.strictEqual(worlds.length, 9);
  ...
  console.log(JSON.stringify({ ok: true, github_default_install: 9, startup_evidence_commit: true, one_shell_plugin_update: true, unchanged_plugin_refs: 8, base_update_check: true, generic_plugin_storage: true }, null, 2));
