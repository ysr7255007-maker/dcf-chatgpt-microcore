...
assert(dialogue);
assert.strictEqual(dialogue.version, '1.0.0-rc.2-local-agent-dialogue.2');
...
console.log(JSON.stringify({ ok: true, pure_base: true, independent_plugins: 10, local_agent_is_pure_plugin: true, dialogue_loop_is_pure_plugin: true, base_unchanged: true, dark_mode: true, next_migration_only: true }, null, 2));
