...
assert.strictEqual(index.defaults.length, 9);
...
console.log(JSON.stringify({ ok: true, pure_base: true, independent_plugins: 9, local_agent_is_pure_plugin: true, base_unchanged: true, dark_mode: true, next_migration_only: true }, null, 2));
