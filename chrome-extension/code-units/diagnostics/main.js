(function () {
  ...
  async function collectLocalAgentDiagnostic(sessionId, requestId) {
    ...
    const statusEvidence = { ok: results.status.ok, normalized: normalizedStatus };
    return {
