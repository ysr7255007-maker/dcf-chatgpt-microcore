...
// @version      0.2.0-alpha.8-complete
// @description  Compiled DCF boot snapshot (complete); plugin code is selected before installation and executed by Tampermonkey.
// @updateURL    https://raw.githubusercontent.com/ysr7255007-maker/dcf-chatgpt-microcore/rewrite-v2-survival-box/dcf-chatgpt-next-snapshot-complete.meta.js
// @downloadURL  https://raw.githubusercontent.com/ysr7255007-maker/dcf-chatgpt-microcore/rewrite-v2-survival-box/dcf-chatgpt-next-snapshot-complete.user.js
...
const { localAgentPlugin: factory2 } = require("src-next/plugins/local-agent.js");
const { ammoPlugin: factory3 } = require("src-next/plugins/ammo.js");
const { conversationPerformancePlugin: factory4 } = require("src-next/plugins/conversation-performance.js");
const { attributionPlugin: factory5 } = require("src-next/plugins/attribution.js");
const { appearancePlugin: factory6 } = require("src-next/plugins/appearance.js");
const { pluginManagerPlugin: factory7 } = require("src-next/plugins/plugin-manager.js");
const { backupPlugin: factory8 } = require("src-next/plugins/backup.js");
const { diagnosticsPlugin: factory9 } = require("src-next/plugins/diagnostics.js");
