...
- `2026-07-20-dcf-managed-web-surface-runtime.md` — **accepted direction; runtime vehicle and first implementation pending comparative spike**; web AI adapters should run inside a DCF-managed browser host while durable scheduling, permissions, recovery and evidence remain in the local core rather than in page JavaScript
