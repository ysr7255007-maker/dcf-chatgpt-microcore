...
- `2026-07-20-dcf-first-install-static-survival.md` — **implementation candidate prepared; CI and BrowserClaw live acceptance pending**; plugin toggles are bounded configuration transactions rather than full code rollouts, static survival prevents silent disappearance, and page execution truth is probed separately from registration truth
