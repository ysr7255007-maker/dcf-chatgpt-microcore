...
Scope note (2026-07-26): this file governs the retained Chrome `rc.3` and legacy old-world implementation. New work under `seed/` follows `docs/vision/2026-07-26-dcf-from-zero-vision-adr.md` and `docs/adr/2026-07-26-dcf-minimal-live-loop-growth-blueprint.md`. Old control-plane objects and plugin boundaries may be consulted as evidence, but are not seed architecture defaults.
